...
rotateAndTranslate = (point, angle, tx, ty) ->
    x = point[0]
    y = point[1]
...
dotProduct = (p0, p1) -> (p0[0] * p1[0]) + (p0[1] * p1[1])
...
###
interRect = (x1, y1, x2, y2, rleft, rtop, rright, rbottom) ->
    dx = x2 - x1
    dy = y2 - y1
...
rectsOverlap = (r1_x1, r1_y1, r1_x2, r1_y2, r2_x1, r2_y1, r2_x2, r2_y2) ->
    if r1_x1 < r2_x2 && r1_x2 > r2_x1 && r1_y1 < r2_y2 && r1_y2 > r2_y1
        return true
    return false


sepAxisSide = (a1, a2, point) ->
...
rectsDist2 = (r1_x1, r1_y1, r1_x2, r1_y2, r2_x1, r2_y1, r2_x2, r2_y2) ->
...
rectsDist = (r1_x1, r1_y1, r1_x2, r1_y2, r2_x1, r2_y1, r2_x2, r2_y2) ->
    dist = rectsDist2(r1_x1, r1_y1, r1_x2, r1_y2, r2_x1, r2_y1, r2_x2, r2_y2)
    Math.sqrt(dist)


lineSegsOverlap = (x1, y1, x2, y2, x3, y3, x4, y4) ->
...
lineRectOverlap = (x1, y1, x2, y2, rect) ->
